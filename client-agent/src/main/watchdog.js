// file: client-agent/src/main/watchdog.js
...
const TASK_NAME = 'MeetChampWatchdog';

/**
 * Write scripts and register the scheduled task.
 *
 * Files written to %AppData%/meetchamp-agent/:
 *   watchdog.ps1      — checks if MeetChamp is running, launches if not
