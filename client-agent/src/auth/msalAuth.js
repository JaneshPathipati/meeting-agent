// file: client-agent/src/auth/msalAuth.js
...
function startLocalServer() {
  return new Promise((resolve, reject) => {
    ...
    const SUCCESS_HTML = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>MeetChamp</title>
...
<body><div class="card"><h3>Sign-in successful!</h3><p>You can close this tab and return to MeetChamp.</p></div></body></html>`;

    const ERROR_HTML = (msg) => `<!DOCTYPE html><html><head><meta charset="utf-8"><title>MeetChamp</title>
<style>body{font-family:-apple-system,Segoe UI,sans-serif;display:flex;justify-content:center;align-items:center;min-height:100vh;margin:0;background:#f8fafc}
.card{text-align:center;padding:2rem;border-radius:12px;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.1)}
h3{color:#dc2626;margin:0 0 .5rem}p{color:#64748b;margin:0;font-size:14px}</style></head>
<body><div class="card"><h3>Sign-in failed</h3><p>${msg}</p><p style="margin-top:.5rem">You can close this tab and try again in MeetChamp.</p></div></body></html>`;
